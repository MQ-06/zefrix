...
function BatchesContent() {
  ...
  useEffect(() => {
    ...
    const existingScript = document.querySelector('script[data-firebase-batches-init]');
    if (existingScript) {
  ...
  useEffect(() => {
    ...
    const fetchBatches = async () => {
      ...
      console.log('✅ Firebase is ready, fetching batches...');
  ...
  const currentBatches = allBatches.slice(startIndex, endIndex);
    ...
    <>
      ...
      <section className="section-spacing-bottom bg-gradient-to-b from-transparent via-[#1A1A2E] to-[#1A1A2E]">
        <div className="container">
          ...
          {/* Pagination */}
          {allBatches.length > 0 && totalPages > 1 && (
